...
const VerifyFooter = () => {
  ...
  const navLinks = [{ name: "Home" }, { name: "Verify" }];

  return (
    <>
      <footer className="bg-[#252525] py-5">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center text-white gap-y-4 md:gap-x-8 lg:gap-x-10">
            ...
            <div
              ...
              onClick={() => router.push('https://wagagaigold.co/')}
            >
              <Image
            ...
            {/* 3. Nav Links */}
            <nav className="flex justify-center space-x-4 sm:space-x-6 lg:space-x-8 order-4 md:order-3">
              {navLinks.map((link) => (
                <div
                  key={link.name}
                  onClick={() => router.push(link.name === "Home" ? 'https://wagagaigold.co/' : 'https://wagagaigold.co/verify')}
            ...
            {/* 4. Contact Us Info */}
            <div className="text-center text-base order-2 md:order-4">
              Contact info:{" "}
              <a
